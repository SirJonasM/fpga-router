...
use router::{FabricGraph, Logging, RoutingConfigBuilder, SimpleSteinerSolver, SteinerSolver, create_fasm, create_test, route};
...
#[test]
fn test_create_test() {
    let graph = FabricGraph::from_file(get_test_data_path("pips_4x4.txt")).unwrap();
